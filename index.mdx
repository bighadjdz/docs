---
title: "Overview"
description: "mcp-analytics is a drop-in SDK that adds powerful analytics and Stripe payments to your Cloudflare MCP servers with just two lines of code.

It's a purpose-built wrapper around the standard McpAgent that handles all the heavy lifting of tracking, error monitoring, and monetization, letting you focus on building great tools."
---

### The Problem: Flying Blind

You've built a great MCP agent, but you're operating in a black box. Critical questions are left unanswered:
